...
API_ID = int(getenv("29838522"))
API_HASH = getenv("ea0003cc221afe6e0ca253c091745703")

BOT_TOKEN = getenv("6874503477:AAFRxS9pmHVBSV1Jm24eo5Hbg4GZSEO4Px4", None)
DURATION_LIMIT = int(getenv("DURATION_LIMIT", "90"))

OWNER_ID = int(getenv("6368506857"))
...
SUDO_USERS = list(map(int, getenv("SUDO_USERS", "5371579102").split()))
